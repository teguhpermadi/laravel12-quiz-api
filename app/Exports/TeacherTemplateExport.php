...
class TeacherTemplateExport implements WithMultipleSheets, ShouldAutoSize
{
    // --- KONSTANTA INI HARUS ADA DI SINI ---
    const TEMPLATE_CODE = 'TEACHER_IMPORT_TEMPLATE_V1.0_20250615'; // Kode unik template
    const TEMPLATE_INFO_SHEET_NAME = 'TemplateInfo'; // Nama sheet info tersembunyi
    const DATA_SHEET_NAME = 'DataGuru'; // Nama sheet data guru
    ...
    public function sheets(): array
    {
        ...
        $sheets[] = new class implements FromCollection, WithHeadings, WithEvents, WithTitle, ShouldAutoSize {
            public function collection()
            {
                ...
                return new Collection([
                    ['template_code', TeacherTemplateExport::TEMPLATE_CODE],
                    ['version', '1.0'],
            ...
            public function title(): string
            {
                ...
                return TeacherTemplateExport::TEMPLATE_INFO_SHEET_NAME;
            }
        ...
        // --- SHEET KEDUA: DataGuru (Template Data Guru) ---
        $sheets[] = new class implements FromCollection, WithHeadings, WithEvents, WithTitle, ShouldAutoSize {
            public function collection()
            {
            ...
            public function headings(): array
            {
                // Header untuk kolom data guru. Ini akan muncul di baris 1.
                return [
                    'Nama Guru',           // Kolom A
            ...
            public function title(): string
            {
                // Nama sheet data guru utama
                return TeacherTemplateExport::DATA_SHEET_NAME;
            }
            ...
            public function registerEvents(): array
            {
                return [
                    AfterSheet::class => function (AfterSheet $event) {
                        ...
                        $sheet->getProtection()->setPassword(TeacherTemplateExport::SHEET_PASSWORD); // Set password
                        ...
                        // --- BUKA KUNCI AREA DATA GURU ---
                        // Data guru bisa diisi mulai dari DATA_CONTENT_START_ROW (baris 2)
                        $lastColumnIndex = count($this->headings()); // Jumlah kolom header
                        $lastColumnLetter = Coordinate::stringFromColumnIndex($lastColumnIndex);
                        $editableDataRange = 'A' . TeacherTemplateExport::DATA_CONTENT_START_ROW . ':' . $lastColumnLetter . '1000'; // Dari A2 sampai baris 1000
                        ...
                        $genderValidationStartRow = TeacherTemplateExport::DATA_CONTENT_START_ROW; // Mulai dari baris 2
                        ...
                        $headerStyleRange = 'A' . TeacherTemplateExport::DATA_HEADER_ROW . ':' . $lastColumnLetter . TeacherTemplateExport::DATA_HEADER_ROW;
